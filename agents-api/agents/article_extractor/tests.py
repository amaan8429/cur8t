...
class TestArticleLinkExtractorService:
    ...
    def test_successful_extraction(self, mock_get):
        ...
        result, error = self.service.extract_links_from_article("https://test-article.com")
    ...
    def test_collection_name_generation(self):
        ...
        with patch('requests.Session.get') as mock_get:
            mock_response = Mock()
            mock_response.content = b"<html><head><title>Test</title></head><body></body></html>"
            mock_response.raise_for_status.return_value = None
            mock_get.return_value = mock_response
        ...
        with patch('requests.Session.get') as mock_get:
            mock_response = Mock()
            mock_response.content = b"<html><head><title>Article Title</title></head><body></body></html>"
            mock_response.raise_for_status.return_value = None
            mock_get.return_value = mock_response
